    ...
    <>
      <section>
        <article>
          ...
          <p>email: {talentUser.email}</p>
          <p>password</p>
          <p>surnames: {talentUser.surnames}</p>
          <p>{talentUser.telephone}</p>
          <p>{talentUser.birthdate}</p>
          <p>{talentUser.streetAddress}</p>
          <p>{talentUser.city}</p>
          <p>código postal : {talentUser.postalCode}</p>
          <p>Formación : {talentUser.education}</p>
          {/* <p>
